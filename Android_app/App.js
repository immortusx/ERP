...
/>
              <Stack.Screen
                ...
                options={{
                  headerLeft: () => <HomeScreen />,
                  title: "Balkrushna Technologies ",
                }}
              />
              <Stack.Screen
                name="Enquiry"
                component={Enquiry}
                options={{ title: "Enqiury " }}
              />
              <Stack.Screen
                name="profile"
                component={Profile}
              ...
              <Stack.Screen
                name="newenquiry"
                component={Form}
                options={{ title: "New Enquiry" }}
              />
              <Stack.Screen
                name="Booking"
                component={Booking}
                options={{ title: "Producet Details" }}
              />
              <Stack.Screen
                name="PriceDetails"
                component={PriceDetails}
                options={{ title: "Price Details" }}
              />
              <Stack.Screen
                name="CoustomerDetails"
                component={CoustomerDetails}
                options={{ title: "Coustomer Details" }}
              />
              <Stack.Screen
                name="DownPayment"
                component={DownPayment}
                options={{ title: "Down Payment" }}
              />
              <Stack.Screen
                name="RtoDetails"
                component={RtoDetails}
                options={{ title: "RTO Details" }}
              />
              <Stack.Screen
                name="ConsumerSkim"
                component={ConsumerSkim}
                options={{ title: "Consumer Skim" }}
              />
              <Stack.Screen
                name="products"
                component={Product}
