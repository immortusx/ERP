        ...
        <div className="container mt-3">
          <form className="row">
            <div className="userd1 col-md-6 d-flex align-item-center flex-column">
              <div class="panel">
                ...
                <div className="userdet d-flex mt-4 flex-column col-12 col-sm-6 col-lg-auto">
                  <p>
                    <span className="sp">Last Name </span>: {userData.lastName}
                  </p>
                </div>

                <div className="userdet d-flex mt-4 flex-column col-12 col-sm-6 col-lg-auto">
                  <p>
                    <span className="sp">Email </span>: {userData.email}
                  </p>
                </div>
                <div className="userdet d-flex mt-4 flex-column col-12 col-sm-6 col-lg-auto">
                  <p>
                    <span className="sp">Mobile no. </span>:{" "}
            ...
            <div className="userd col-md-6">
              ...
              <button onClick={handleSubmit} className="btnc">
                Change Password
              </button>
            </div>
          </form>
