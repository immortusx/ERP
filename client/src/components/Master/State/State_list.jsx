...
import {getAllStateAction, editeStateAction} from './getEditeSate'
        ...
        },
        {
            ...
            renderCell: (params) => (
                <div>
                    ...
                    <button className='myActionBtn m-1' onClick={() => { editeStateAction(params.row) }}>
                    ...
                    <button className='myActionBtn m-1' onClick={() => { deleteStateActino(params.row) }}>
