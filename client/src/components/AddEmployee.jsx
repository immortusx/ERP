...
import { addemployeeToDb, clearAddemployeeState } from '../redux/slices/addemployeeSlice'
import { clearEditemployeeState, clearEditemployeeData, editemployeeUpdateToDb } from '../redux/slices/editemployeeDataSlice'
...
export default function Addemployee({ workFor }) {
    ...
    const addemployeeState = useSelector(state => state.addemployeeSlice.addemployeeState)
    const { editemployeeSliceState } = useSelector(state => state.editemployeeDataState)
    const editemployeeData = useSelector(state => state.editemployeeDataState.editemployeeData.data)
                ...
                <main>
                    ...
                    <div className=' row mt-3 m-0'>
                        <main className='px-3 d-flex align-items-center'>
                            <input type='checkbox' className='myCheckBox inputElement' onChange={(e) => { onChangeHandler(e) }} name="enableemployee" />
                            <label className='ms-2 myLabel' htmlFor="">Enable employee </label>
                        </main>
                        <section className='d-flex mt-3 flex-column col-12 col-sm-6 col-lg-4'>
                            <label className='myLabel' htmlFor="email">First Name </label>
                            <input value={employeeData.firstName} className='myInput inputElement' autoComplete='false' onChange={(e) => { onChangeHandler(e) }} type="text" name="firstName" />
                        </section>
                        <section className='d-flex mt-3 flex-column col-12 col-sm-6 col-lg-4'>
                            <label className='myLabel' htmlFor="email">Last Name</label>
                            <input value={employeeData.lastName} className='myInput inputElement' autoComplete='false' onChange={(e) => { onChangeHandler(e) }} type="text" name="lastName" />
                        </section>
                        <section className='d-flex mt-3 flex-column col-12 col-sm-6 col-lg-4'>
                            <label className='myLabel' htmlFor="email">Work Email</label>
                            <input value={employeeData.email} className='myInput inputElement' autoComplete='false' onChange={(e) => { onChangeHandler(e) }} type="text" name="email" />
                        </section>
                        <section className='d-flex mt-3 flex-column col-12 col-sm-6 col-lg-4'>
                            <label className='myLabel' htmlFor="email">Phone Number</label>
                            <input value={employeeData.phoneNumber} className='myInput inputElement' autoComplete='false' onChange={(e) => { onChangeHandler(e) }} type="number" name="phoneNumber" />
                        </section>
                        <section className='d-flex mt-3 flex-column col-12 col-sm-6 col-lg-4'>
                            <label className='myLabel' htmlFor="password">{workFor === 'forAdd' ? 'Password' : 'New password'}</label>
                            <input value={employeeData.password} className='myInput inputElement' autoComplete='false' onChange={(e) => { onChangeHandler(e) }} type="password" name="password" />
                        </section>
                        <section className='d-flex mt-3 flex-column col-12 col-sm-6 col-lg-4'>
                            <label className='myLabel' htmlFor="email">Date of Birth</label>
                            <DatePicker
                        ...
                        <section className='d-flex mt-3 flex-column col-12 col-sm-6 col-lg-4'>
                            <label className='myLabel' htmlFor="bloodGroup">Blood Group</label>
                            <select className="form-control" id="bloodGroup" name="bloodGroup" onChange={(e) => setBloodGroup(e.target.value)} value={bloodgroup}>
                    ...
                    <div className=' row m-0'>
                        ...
                        <main className='mt-4'>
                            ...
                            <div className=' row mt-3 m-0'>
                                ...
                                <section className='d-flex mt-3 flex-column col-12 col-sm-6 col-lg-4'>
                                    <label className='myLabel' htmlFor="email">Bank Branch </label>
                                    <input value={BankDetais.bankBranch} className='myInput inputElement' autoComplete='false' onChange={(e) => { onChangeBankDetais(e) }} type="text" name="bankBranch" />
                                </section>
                                <section className='d-flex mt-3 flex-column col-12 col-sm-6 col-lg-4'>
                        ...
                        <section className='d-flex mt-3  flex-column flex-sm-row'>
                            <button className='col-12 col-sm-5 col-lg-2 myBtn py-2' onClick={handleSubmit} type='button'>{workFor === 'forAdd' ? 'Add employee' : 'Edit employee'}</button>
