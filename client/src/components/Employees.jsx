...
import { getemployeeListFromDb, clearemployeeListState } from '../redux/slices/getemployeeListSlice'
...
export default function Employees() {
  ...
  const employeeListState = useSelector(state => state.getemployeeListSlice.employeeListState);
  ...
  const rowsData = employeeListData.map((item, index) => ({ ...item, rowNumber: index + 1 }));
  ...
  useEffect(() => {
    if (employeeListState.isSuccess) {
      if (employeeListState.list.isSuccess) {
        ...
        console.log('employeeListState.list.isSuccess', employeeListState.list.result)
    ...
    <>
      <div className=''>
        ...
        <div className='my-3  d-flex align-items-end justify-content-end'>
          <div onClick={() => { navigate('/administration/employees/addemployee') }} className='d-flex align-items-center' type='button'>
