...
router.post('/add-new-branch', async (req, res) => {
  ...
  const url = `INSERT INTO branches(name, mobile_number,email_id,address,code,create_date,gst_number,description,contact_person) VALUES('${req.body.firmName}','${req.body.mobileNumber}','${req.body.email}','${req.body.address}','${req.body.code}','${cdate}','${req.body.gstNumber}','${req.body.description}','${req.body.contactPerson}')`;
...
router.post('/edit-branch-details', async (req, res) => {
  ...
  // var cdate = moment().format('YYYY-MM-DD H:m:s');
  // console.log('cdate', cdate)
  const url = `UPDATE branches SET name='${req.body.firmName}',mobile_number='${req.body.mobileNumber}',email_id='${req.body.email}',address='${req.body.address}',code='${req.body.code}',gst_number='${req.body.gstNumber}',description='${req.body.description}',contact_person='${req.body.contactPerson}' WHERE id = ${req.body.id}`;
