...
const Enquiries = () => {
  ...
  const item = useSelector(state => state.taskItem.taskItem);
  ...
  const handleNextEnquiry = () => {
    if (
      ...
      console.log(
        'Button disabled: Duration < 5 or non-OUTGOING call or different phone number',
      );
      return;
    }
    console.log('Next');
